...
bspInit(uint32_t ui32SysClockSpeed)
{
    ...
    // serial output. Tx and Rx Radio Test, (FloripaSat prototipo)
    //P8SEL |= 0x04;                            // Assign P8.2 to UCA1TXD
    //P8DIR |= 0x04;                            // P8.2 to output


    // serial output. Tx and Rx Radio Test, (FloripaSat EngModel)
    P9SEL |= BIT2;                            // Assign P9.2 to UCA2TXD
    P9DIR |= BIT2;                            // P9.2 to output
