...
#ifndef EPS_MAIN_EPS_TIMER_TEST_H_
#define EPS_MAIN_EPS_TIMER_TEST_H_
...
extern volatile int temp[3];
volatile unsigned char EPSData_beacon[10];

void make_frame(void);

#endif /* EPS_MAIN_EPS_TIMER_TEST_H_ */
